...
class OpenAIChatModel(Model):
    ...
    async def _completions_create(
        ...
        # Use our own message mapping to respect system_prompt_role configuration
        openai_messages = await self._map_messages(messages)

        # Call the compatibility layer but with our pre-mapped messages
